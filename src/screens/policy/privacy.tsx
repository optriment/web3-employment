      ...
      <Grid.Column textAlign="justified">
        <Container text>
          <p>
            ...
            optritool.optriment.com website (“Website” or “Service”) and any of
            its related products and services (collectively, “Services”), and
          ...
          <p>
            ...
            “you” or “your”) and OPTRIMENT COMPUTER SYSTEMS & COMMUNICATION
            EQUIPMENT (doing business as “OPTRIMENT”, “we”, “us” or “our”). If
        ...
        <Header
          as="h2"
          content="Automatic collection of information"
          textAlign="center"
        />
        ...
        <Header
          as="h2"
          content="Collection of personal information"
          textAlign="center"
        />
        ...
        <Header as="h2" content="Privacy of children" textAlign="center" />
        ...
        <Header
          as="h2"
          content="Use and processing of collected information"
          textAlign="center"
        />
        ...
        <Container text>
          ...
          <List bulleted>
            <List.Item>Create and manage user accounts</List.Item>
            <List.Item>Fulfill and manage orders</List.Item>
            <List.Item>Deliver products or services</List.Item>
            <List.Item>Improve products and services</List.Item>
            <List.Item>Send administrative information</List.Item>
            <List.Item>Send marketing and promotional communications</List.Item>
            <List.Item>Send product and service updates</List.Item>
            <List.Item>Respond to inquiries and offer support</List.Item>
            <List.Item>Request user feedback</List.Item>
            <List.Item>Improve user experience</List.Item>
            <List.Item>Post customer testimonials</List.Item>
            <List.Item>Deliver targeted advertising</List.Item>
            <List.Item>Administer prize draws and competitions</List.Item>
            <List.Item>Enforce terms and conditions and policies</List.Item>
            <List.Item>Protect from abuse and malicious users</List.Item>
            <List.Item>Respond to legal requests and prevent harm</List.Item>
            <List.Item>Run and operate the Website and Services</List.Item>
          </List>
          ...
          <List bulleted>
            <List.Item>User’s consent</List.Item>
            <List.Item>Performance of a contract</List.Item>
            <List.Item>Our own legitimate interests</List.Item>
          </List>
        ...
        <Header as="h2" content="Payment processing" textAlign="center" />
        ...
        <Header as="h2" content="Managing information" textAlign="center" />
        ...
        <Header
          as="h2"
          content="Disclosure of information"
          textAlign="center"
        />
        ...
        <Header as="h2" content="Retention of information" textAlign="center" />
        ...
        <Header as="h2" content="Transfer of information" textAlign="center" />
        ...
        <Header
          as="h2"
          content="Data protection rights under the GDPR"
          textAlign="center"
        />
        ...
        <Header
          as="h2"
          content="California privacy rights"
          textAlign="center"
        />
        ...
        <Header
          as="h2"
          content="How to exercise your rights"
          textAlign="center"
        />
        ...
        <Header as="h2" content="Cookies" textAlign="center" />
        ...
        <Container text>
          <p>
            ...
            will not be able to use and experience the features of the Website
            and Services.
          </p>
          ...
          <p>
            ...
            and for statistical purposes. For further information on the cookies
            we collect and their purpose, see our{' '}
            <Link href="/policy/cookie">cookie policy</Link>. Please note that
        ...
        <Header as="h2" content="Do Not Track signals" textAlign="center" />
        ...
        <Header as="h2" content="Links to other resources" textAlign="center" />
        ...
        <Header as="h2" content="Information security" textAlign="center" />
        ...
        <Header as="h2" content="Data breach" textAlign="center" />
        ...
        <Container text>
          <p>
            ...
            following email:{' '}
            <a href="mailto:office@optriment.com">office@optriment.com</a>.
          </p>
