    ...
    describe('when there are recipients', () => {
      ...
      describe('when there are payments', () => {
        ...
        it('returns a specific group, assigned recipients to it, and recipients payments', async () => {
          ...
          expect(result.data.payments[0].id).toEqual(firstRecipientPayment2.id)
          ...
          expect(result.data.payments[1].id).toEqual(secondRecipientPayment.id)
          ...
          expect(result.data.payments[2].id).toEqual(firstRecipientPayment1.id)
